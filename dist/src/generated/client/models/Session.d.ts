...
export type SessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "token" | "refreshToken" | "expiresAt" | "ipAddress" | "userAgent" | "isActive" | "createdAt" | "updatedAt", ExtArgs["result"]["session"]>;

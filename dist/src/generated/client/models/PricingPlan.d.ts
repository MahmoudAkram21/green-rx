...
export type GetPricingPlanAggregateType<T extends PricingPlanAggregateArgs> = {
    [P in keyof T & keyof AggregatePricingPlan]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregatePricingPlan[P]> : Prisma.GetScalarType<T[P], AggregatePricingPlan[P]>;
};
...
type GetPricingPlanGroupByPayload<T extends PricingPlanGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<PricingPlanGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof PricingPlanGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], PricingPlanGroupByOutputType[P]> : Prisma.GetScalarType<T[P], PricingPlanGroupByOutputType[P]>;
}>>;
export type PricingPlanWhereInput = {
    ...
    salePrice?: Prisma.DecimalNullableFilter<"PricingPlan"> | runtime.Decimal | runtime.DecimalJsLike | number | string | null;
    duration?: Prisma.IntFilter<"PricingPlan"> | number;
    isDefault?: Prisma.BoolFilter<"PricingPlan"> | boolean;
    features?: Prisma.JsonNullableFilter<"PricingPlan">;
...
export type PricingPlanScalarWhereWithAggregatesInput = {
    ...
    salePrice?: Prisma.DecimalNullableWithAggregatesFilter<"PricingPlan"> | runtime.Decimal | runtime.DecimalJsLike | number | string | null;
    duration?: Prisma.IntWithAggregatesFilter<"PricingPlan"> | number;
    isDefault?: Prisma.BoolWithAggregatesFilter<"PricingPlan"> | boolean;
    features?: Prisma.JsonNullableWithAggregatesFilter<"PricingPlan">;
...
export type PricingPlanOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "price" | "salePrice" | "duration" | "isDefault" | "features" | "isActive" | "createdAt" | "updatedAt", ExtArgs["result"]["pricingPlan"]>;
...
export type PricingPlanCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<PricingPlanFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PricingPlanDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends PricingPlanCountArgs>(args?: Prisma.Subset<T, PricingPlanCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], PricingPlanCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends PricingPlanGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, PricingPlanGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPricingPlanGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface PricingPlanFieldRefs {
    ...
    readonly salePrice: Prisma.FieldRef<"PricingPlan", 'Decimal'>;
    readonly duration: Prisma.FieldRef<"PricingPlan", 'Int'>;
    readonly isDefault: Prisma.FieldRef<"PricingPlan", 'Boolean'>;

...
router.get('/', (0, auth_middleware_1.authorize)(['Admin', 'SuperAdmin']), diseaseWarningRule_controller_1.default.getAllWarningRules);
...
router.post('/', (0, auth_middleware_1.authorize)(['Admin', 'SuperAdmin']), diseaseWarningRule_controller_1.default.createWarningRule);
// Update a warning rule (Admin only)
router.patch('/:id', (0, auth_middleware_1.authorize)(['Admin', 'SuperAdmin']), diseaseWarningRule_controller_1.default.updateWarningRule);
// Delete a warning rule (Admin only)
router.delete('/:id', (0, auth_middleware_1.authorize)(['Admin', 'SuperAdmin']), diseaseWarningRule_controller_1.default.deleteWarningRule);

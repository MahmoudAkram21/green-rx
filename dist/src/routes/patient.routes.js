...
// Lifestyle
router.get('/:patientId/lifestyle', patient_controller_1.getPatientLifestyles);
router.post('/:patientId/lifestyle', (0, auth_middleware_1.authorize)([client_1.UserRole.Patient, client_1.UserRole.Doctor, client_1.UserRole.Admin, client_1.UserRole.SuperAdmin]), patient_controller_1.addOrUpdatePatientLifestyles);
router.delete('/lifestyle/:patientLifestyleId', (0, auth_middleware_1.authorize)([client_1.UserRole.Patient, client_1.UserRole.Doctor, client_1.UserRole.Admin, client_1.UserRole.SuperAdmin]), patient_controller_1.deletePatientLifestyle);
// Allergies
...
// Surgeries
router.get('/:patientId/surgeries', patient_controller_1.getSurgeries);
router.post('/:patientId/surgeries', (0, auth_middleware_1.authorize)([client_1.UserRole.Patient, client_1.UserRole.Doctor, client_1.UserRole.Admin, client_1.UserRole.SuperAdmin]), patient_controller_1.addSurgeries);
router.delete('/surgeries/:surgeryId', (0, auth_middleware_1.authorize)([client_1.UserRole.Patient, client_1.UserRole.Doctor, client_1.UserRole.Admin, client_1.UserRole.SuperAdmin]), patient_controller_1.deleteSurgery);

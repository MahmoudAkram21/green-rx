...
router.post("/", (0, auth_middleware_1.authorize)([client_1.UserRole.Doctor]), medicineSuggestion_controller_1.default.createSuggestion);
// Review a suggestion (Admin only)
router.patch("/:id/review", (0, auth_middleware_1.authorize)([client_1.UserRole.Admin, client_1.UserRole.SuperAdmin]), medicineSuggestion_controller_1.default.reviewSuggestion);
// Delete a suggestion

...
router.get('/pharmacists/pending', admin_controller_1.default.getPendingPharmacists);
router.patch('/pharmacists/:id/verify', admin_controller_1.default.verifyPharmacist);
router.patch('/pharmacists/:id/reject', admin_controller_1.default.rejectPharmacist);
// Statistics

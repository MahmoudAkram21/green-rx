...
async function main() {
    ...
    const diseases = await Promise.all([
        prisma.disease.create({
            data: {
                ...
                severity: "Moderate",
                description: "Chronic metabolic disorder characterized by high blood sugar levels",
            },
        }),
        prisma.disease.create({
            data: {
    ...
    await prisma.medicalHistory.createMany({
        data: [
            // Patient 1 (Alice Cooper) - Multiple conditions
            {
                ...
                treatment: "Metformin 500mg twice daily, lifestyle modifications, regular exercise",
                status: "Chronic",
                notes: "Well controlled with medication. HbA1c: 6.8% (last check). Fasting glucose: 110-120 mg/dL. Patient compliant with diet and medication.",
            },
            {
                patientId: patients[0].id,
                ...
                status: "Active",
                notes: "Borderline hypertension, managed with diet and exercise. BP: 135/88 mmHg",
            },
            // Patient 2 (Bob Martinez) - Multiple chronic conditions
            {
                ...
                treatment: "Amlodipine 5mg once daily, low sodium diet, regular monitoring",
                status: "Chronic",
                notes: "BP controlled. Last reading: 130/85 mmHg. Patient advised to reduce salt intake and maintain healthy weight.",
            },
            {
                patientId: patients[1].id,
                ...
                status: "Chronic",
                notes: "Cholesterol levels improving. Total cholesterol: 180 mg/dL (down from 240). LDL: 110 mg/dL. Triglycerides: 150 mg/dL.",
            },
            {
                patientId: patients[1].id,
                ...
                status: "Active",
                notes: "High risk due to family history. Regular EKG and stress tests recommended. Currently asymptomatic.",
            },
            // Patient 3 (Carol White) - Allergic conditions
            {
                ...
                treatment: "Cetirizine 10mg as needed, nasal corticosteroid spray, allergen avoidance",
                status: "Active",
                notes: "Seasonal allergies, worse in spring (pollen) and fall (ragweed). Symptoms include sneezing, nasal congestion, and itchy eyes.",
            },
            {
                patientId: patients[2].id,
                ...
                status: "Active",
                notes: "Exercise-induced asthma. Symptoms occur during vigorous exercise. Well controlled with pre-exercise medication.",
            },
            // Patient 4 (David Lee) - GERD and related
            {
                ...
                treatment: "Omeprazole 20mg once daily before breakfast, dietary modifications, elevate head of bed",
                status: "Active",
                notes: "Symptoms well controlled. Patient avoids trigger foods (spicy, acidic, fatty). No nighttime symptoms since treatment.",
            },
            {
                patientId: patients[3].id,
                ...
                treatment: "Lifestyle modifications, monitoring",
                status: "Active",
                notes: "Borderline hypertension. BP: 138/88 mmHg. Monitoring without medication initially.",
            },
            // Patient 5 (Emma Thompson) - Pediatric conditions
            {
                ...
                treatment: "Salbutamol inhaler as needed, avoid triggers (cold air, exercise, allergens)",
                status: "Active",
                notes: "Exercise-induced asthma. Symptoms occur during physical activity. Uses inhaler before PE class. No nighttime symptoms.",
            },
            {
                patientId: patients[4].id,
                diseaseId: diseases[6].id, // Allergic Rhinitis
                ...
                treatment: "Cetirizine 5mg as needed (pediatric dose), nasal saline rinses",
                status: "Active",
                notes: "Seasonal allergies, primarily in spring. Symptoms include runny nose and sneezing.",
            },
        ],
    });
    ...
    await prisma.familyHistory.createMany({
        data: [
            // Patient 1 (Alice Cooper) - Family History
            {
                ...
                severity: "Moderate",
                notes: "Diagnosed at age 55. Type 2 Diabetes. Currently on medication. HbA1c controlled around 7.0%",
            },
            {
                patientId: patients[0].id,
                relation: "Father",
                diseaseId: diseases[1].id, // Hypertension
                severity: "Moderate",
                notes: "Diagnosed at age 58. On antihypertensive medication. BP well controlled.",
            },
            {
                patientId: patients[0].id,
            ...
            },
            {
                ...
                severity: "Severe",
                notes: "Heart attack at age 72. Had bypass surgery. Died at age 78 from cardiac complications.",
            },
            {
                patientId: patients[0].id,
                relation: "Sister",
            ...
            // Patient 2 (Bob Martinez) - Extensive Family History
            {
                ...
                diseaseId: diseases[7].id, // Coronary Artery Disease
                severity: "Severe",
                notes: "Heart attack at age 65. Had triple bypass surgery. Currently on multiple cardiac medications.",
            },
            {
                patientId: patients[1].id,
                relation: "Father",
            ...
            },
            {
                ...
                diseaseId: diseases[2].id, // Asthma
                severity: "Moderate",
                notes: "Childhood asthma, now well controlled. Uses inhaler occasionally.",
            },
            {
                patientId: patients[2].id,
                relation: "Maternal Grandmother",
            ...
            // Patient 4 (David Lee) - GERD and Cardiovascular
            {
                ...
                diseaseId: diseases[3].id, // GERD
                severity: "Moderate",
                notes: "Chronic GERD, on long-term PPI therapy. Had endoscopy showing esophagitis.",
            },
            {
                patientId: patients[3].id,
                relation: "Father",
    ...
    await prisma.patientDisease.createMany({
        data: [
            // Patient 1 (Alice Cooper)
            {
                ...
                severity: "Moderate",
                status: "Chronic",
                notes: "Type 2 Diabetes, well controlled. HbA1c: 6.8%. Fasting glucose: 110-120 mg/dL. Patient compliant with medication and diet.",
            },
            {
                patientId: patients[0].id,
                ...
                severity: "Mild",
                status: "Active",
                notes: "Borderline hypertension. BP: 135/88 mmHg. Managing with lifestyle modifications.",
            },
            // Patient 2 (Bob Martinez)
            {
                ...
                severity: "Moderate",
                status: "Chronic",
                notes: "Essential hypertension. BP controlled with medication. Last reading: 130/85 mmHg. Regular monitoring required.",
            },
            {
                patientId: patients[1].id,
                diseaseId: diseases[4].id, // Hyperlipidemia
                ...
                severity: "Moderate",
                status: "Chronic",
                notes: "Mixed hyperlipidemia. Total cholesterol: 180 mg/dL (down from 240). LDL: 110 mg/dL. Triglycerides: 150 mg/dL. Responding well to statin therapy.",
            },
            {
                patientId: patients[1].id,
                ...
                severity: "Mild",
                status: "Active",
                notes: "High risk due to family history. Regular cardiac monitoring. Currently asymptomatic. EKG normal. Stress test pending.",
            },
            // Patient 3 (Carol White)
            {
                ...
                severity: "Mild",
                status: "Active",
                notes: "Seasonal allergic rhinitis. Primary triggers: pollen (spring), ragweed (fall). Symptoms include sneezing, nasal congestion, itchy eyes.",
            },
            {
                patientId: patients[2].id,
                ...
                severity: "Mild",
                status: "Active",
                notes: "Exercise-induced asthma. Symptoms occur during vigorous exercise. Well controlled with pre-exercise bronchodilator.",
            },
            // Patient 4 (David Lee)
            {
                patientId: patients[3].id,
                ...
                severity: "Mild",
                status: "Active",
                notes: "Gastroesophageal reflux disease. Symptoms well controlled with PPI therapy. No nighttime symptoms. Avoids trigger foods.",
            },
            {
                patientId: patients[3].id,
                diseaseId: diseases[1].id, // Hypertension (borderline)
                ...
                severity: "Mild",
                status: "Active",
                notes: "Borderline hypertension. BP: 138/88 mmHg. Monitoring without medication initially. Lifestyle modifications recommended.",
            },
            // Patient 5 (Emma Thompson)
            {
                ...
                severity: "Mild",
                status: "Active",
                notes: "Exercise-induced asthma in pediatric patient. Uses rescue inhaler before physical activity. No nighttime symptoms. Regular monitoring.",
            },
            {
                patientId: patients[4].id,
                diseaseId: diseases[6].id, // Allergic Rhinitis
                ...
                severity: "Mild",
                status: "Active",
                notes: "Seasonal allergies, primarily in spring. Symptoms include runny nose and sneezing. Managed with pediatric dose antihistamines.",
            },
        ],
    });
    ...
    await prisma.appointment.createMany({
        data: [
            ...
            },
            {
                ...
                duration: 45,
                status: "Confirmed",
                notes: "Follow-up on hypertension and hyperlipidemia - review lab results",
                reminderSent: true,
            },
            {
                patientId: patients[2].id,
        ...
        data: [
            {
                ...
                notes: "Patient reports good glucose control. No hypoglycemic episodes.",
            ...
            },
            {
                ...
                diagnosis: "Hypertension - Controlled, Hyperlipidemia - Under treatment",
                followUpRequired: true,
        ...
        data: [
            {
                ...
                isNewVisit: false,
                diagnosis: "Type 2 Diabetes Mellitus - Well controlled",
                treatmentPlan: "Continue Metformin 500mg BID. Monitor HbA1c every 3 months.",
            ...
            },
            {
                ...
                treatmentPlan: "Continue Amlodipine 5mg daily and Atorvastatin 20mg at bedtime",
    ...
    await prisma.importHistory.createMany({
        data: [
            ...
            },
            {
                ...
                errors: client_1.Prisma.JsonNull,
                executionTime: 1820,
            },
            {
    ...
    console.log(`   - 13 Users (1 SuperAdmin, 2 Admins, 3 Doctors, 2 Pharmacists, 5 Patients)`);
    ...
    const warningRules = await Promise.all([
        ...
        prisma.diseaseWarningRule.create({
            data: {
                diseaseId: diseases.find((d) => d.name.includes("Breast Cancer") || d.name.includes("Cancer"))?.id || diseases[0].id,
                ruleType: "BLOCK_ACTIVE_SUBSTANCE",
                targetActiveSubstanceId: activeSubstances.find((a) => a.activeSubstance.includes("MMR") ||
                    a.activeSubstance.includes("Vaccine"))?.id,
                severity: "Critical",
                warningMessage: "🔴 CRITICAL: Live vaccines are absolutely contraindicated during active chemotherapy. Risk of severe infection.",
                autoBlock: true,
        ...
        prisma.diseaseWarningRule.create({
            data: {
                diseaseId: diseases.find((d) => d.name.includes("Diabetes"))?.id ||
                    diseases[1].id,
                ruleType: "WARN_ACTIVE_SUBSTANCE",
                targetActiveSubstanceId: activeSubstances.find((a) => a.activeSubstance.includes("Ibuprofen") ||
                    a.activeSubstance.includes("NSAID"))?.id,
                severity: "High",
                warningMessage: "🟠 WARNING: NSAIDs may affect blood glucose control. Monitor blood sugar closely.",
                autoBlock: false,
                requiresOverride: false,
        ...
        prisma.diseaseWarningRule.create({
            data: {
                ...
                severity: "Critical",
                warningMessage: "🔴 PREGNANCY CATEGORY D: Fetal toxicity risk. Contraindicated in 2nd and 3rd trimesters.",
                autoBlock: true,
                requiresOverride: false,
        ...
        prisma.diseaseWarningRule.create({
            data: {
                diseaseId: diseases.find((d) => d.name.includes("Kidney") || d.name.includes("Renal"))?.id ||
                    diseases[3]?.id ||
                    diseases[0].id,
                ruleType: "REQUIRE_MONITORING",
                severity: "High",
                warningMessage: "🟠 RENAL WARNING: Dose adjustment required for patients with renal impairment.",
                autoBlock: false,
                requiresOverride: false,
                requiredMonitoring: "Serum creatinine, GFR, and electrolytes weekly for first month",
                createdBy: admin1.id,
            },
        }),
        ...
        prisma.diseaseWarningRule.create({
            data: {
                diseaseId: diseases.find((d) => d.name.includes("Liver") || d.name.includes("Hepatic"))?.id ||
                    diseases[4]?.id ||
                    diseases[0].id,
                ruleType: "BLOCK_DRUG_CLASS",
                targetDrugClass: "Hepatotoxic Agents",
                severity: "Critical",
                warningMessage: "🔴 HEPATIC WARNING: This drug class is contraindicated in active liver disease. Risk of hepatic failure.",
                autoBlock: true,
                requiresOverride: true,
                requiredMonitoring: "Liver function tests (AST, ALT, Bilirubin) before and weekly during treatment",
                createdBy: superAdmin.id,
            },
        }),
    ]);
    ...
    const medicineSuggestions = await Promise.all([
        ...
        prisma.medicineSuggestion.create({
            data: {
                ...
                reason: "Many type 2 diabetic patients are requesting this GLP-1 agonist for better glucose control and weight management. It has shown excellent results in clinical trials.",
                status: "Pending",
            },
        }),
        ...
        prisma.medicineSuggestion.create({
            data: {
                ...
                manufacturer: "Sanofi",
                reason: "Effective biologic for moderate-to-severe atopic dermatitis. Several patients with resistant eczema would benefit.",
                status: "Approved",
                reviewedBy: superAdmin.id, // SuperAdmin
                reviewNotes: "Excellent suggestion. Added to catalog as requested. Will be available for prescribing starting next week.",
        ...
        prisma.medicineSuggestion.create({
            data: {
                ...
                reviewNotes: "We already have Paracetamol 500mg in multiple brands. Patients can take 2 tablets for 1000mg dose. No need for separate product.",
        ...
        prisma.medicineSuggestion.create({
            data: {
                ...
                manufacturer: "Merck",
                reason: "Advanced antibiotic for complicated UTIs and intra-abdominal infections. Needed for patients with multi-drug resistant bacteria.",
                status: "Pending",
            },
        }),
    ]);

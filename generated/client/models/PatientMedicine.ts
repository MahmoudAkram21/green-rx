...
// @ts-nocheck 
/*
 * This file exports the `PatientMedicine` model and its related types.
 *
...
export type GetPatientMedicineAggregateType<T extends PatientMedicineAggregateArgs> = {
      [P in keyof T & keyof AggregatePatientMedicine]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePatientMedicine[P]>
    : Prisma.GetScalarType<T[P], AggregatePatientMedicine[P]>
}
...
type GetPatientMedicineGroupByPayload<T extends PatientMedicineGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PatientMedicineGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PatientMedicineGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PatientMedicineGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PatientMedicineGroupByOutputType[P]>
      }
    >
  >
...
export type PatientMedicineCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PatientMedicineFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PatientMedicineDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PatientMedicine'], meta: { name: 'PatientMedicine' } }
  /**
   ...
   * })
  **/
  count<T extends PatientMedicineCountArgs>(
    args?: Prisma.Subset<T, PatientMedicineCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PatientMedicineCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PatientMedicineGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PatientMedicineGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPatientMedicineGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

...
// @ts-nocheck 
/*
 * This file exports the `MedicineSuggestion` model and its related types.
 *
...
export type GetMedicineSuggestionAggregateType<T extends MedicineSuggestionAggregateArgs> = {
      [P in keyof T & keyof AggregateMedicineSuggestion]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMedicineSuggestion[P]>
    : Prisma.GetScalarType<T[P], AggregateMedicineSuggestion[P]>
}
...
type GetMedicineSuggestionGroupByPayload<T extends MedicineSuggestionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MedicineSuggestionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MedicineSuggestionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MedicineSuggestionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MedicineSuggestionGroupByOutputType[P]>
      }
    >
  >
...
export type MedicineSuggestionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MedicineSuggestionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MedicineSuggestionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MedicineSuggestion'], meta: { name: 'MedicineSuggestion' } }
  /**
   ...
   * })
  **/
  count<T extends MedicineSuggestionCountArgs>(
    args?: Prisma.Subset<T, MedicineSuggestionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MedicineSuggestionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MedicineSuggestionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MedicineSuggestionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMedicineSuggestionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

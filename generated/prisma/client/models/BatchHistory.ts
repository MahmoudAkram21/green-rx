...
// @ts-nocheck 
/*
 * This file exports the `BatchHistory` model and its related types.
 *
...
export type GetBatchHistoryAggregateType<T extends BatchHistoryAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBatchHistory[P]>
    : Prisma.GetScalarType<T[P], AggregateBatchHistory[P]>
}
...
type GetBatchHistoryGroupByPayload<T extends BatchHistoryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BatchHistoryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BatchHistoryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BatchHistoryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BatchHistoryGroupByOutputType[P]>
      }
    >
  >
...
export type BatchHistoryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface BatchHistoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends BatchHistoryCountArgs>(
    args?: Prisma.Subset<T, BatchHistoryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BatchHistoryCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, BatchHistoryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBatchHistoryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

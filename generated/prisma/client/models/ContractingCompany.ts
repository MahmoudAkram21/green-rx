...
// @ts-nocheck 
/*
 * This file exports the `ContractingCompany` model and its related types.
 *
...
export type GetContractingCompanyAggregateType<T extends ContractingCompanyAggregateArgs> = {
      [P in keyof T & keyof AggregateContractingCompany]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateContractingCompany[P]>
    : Prisma.GetScalarType<T[P], AggregateContractingCompany[P]>
}
...
type GetContractingCompanyGroupByPayload<T extends ContractingCompanyGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ContractingCompanyGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ContractingCompanyGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ContractingCompanyGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ContractingCompanyGroupByOutputType[P]>
      }
    >
  >
...
export type ContractingCompanyCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ContractingCompanyFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ContractingCompanyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ContractingCompany'], meta: { name: 'ContractingCompany' } }
  /**
   ...
   * })
  **/
  count<T extends ContractingCompanyCountArgs>(
    args?: Prisma.Subset<T, ContractingCompanyCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ContractingCompanyCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ContractingCompanyGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ContractingCompanyGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetContractingCompanyGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

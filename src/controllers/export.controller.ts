...
class ExportController {
    ...
    async exportActiveSubstances(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            res.setHeader(
                'Content-Disposition',
                `attachment; filename=ActiveSubstances_${new Date().toISOString().split('T')[0]}.xlsx`
            );
    ...
    // Export Trade Names
    async exportTradeNames(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            res.setHeader(
                'Content-Disposition',
                `attachment; filename=TradeNames_${new Date().toISOString().split('T')[0]}.xlsx`
            );
    ...
    // Export Diseases
    async exportDiseases(_req: Request, res: Response, next: NextFunction) {
        try {
            ...
            res.setHeader(
                'Content-Disposition',
                `attachment; filename=Diseases_${new Date().toISOString().split('T')[0]}.xlsx`
            );
    ...
    // Export Companies
    async exportCompanies(_req: Request, res: Response, next: NextFunction) {
        try {
            ...
            res.setHeader(
                'Content-Disposition',
                `attachment; filename=Companies_${new Date().toISOString().split('T')[0]}.xlsx`
            );

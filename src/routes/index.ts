...
import allergenCategoryRoutes from './allergenCategory.routes';
...
import addMedicineRequestRoutes from './addMedicineRequest.routes';
...
router.use('/allergen-categories', allergenCategoryRoutes);
...
router.use('/add-medicine-requests', addMedicineRequestRoutes);

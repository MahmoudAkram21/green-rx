...
s('/doctors/{doctorId}/patients/warnings', 'get', [DOCTOR_TAGS.MY_PATIENTS, DOCTOR_PATIENTS_SECTION, DOCTOR_TAGS.DRUG_SAFETY], 'Get aggregated warnings for all patients linked to this doctor. Returns { patients: [ { patientId, name, patientName, email, warnings, byMedicine } ] }. Same warning types as GET /patients/:patientId/warnings per patient.', true, [p('doctorId')]);

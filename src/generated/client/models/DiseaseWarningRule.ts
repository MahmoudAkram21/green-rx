...
// @ts-nocheck 
/*
 * This file exports the `DiseaseWarningRule` model and its related types.
 *
...
export type GetDiseaseWarningRuleAggregateType<T extends DiseaseWarningRuleAggregateArgs> = {
      [P in keyof T & keyof AggregateDiseaseWarningRule]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDiseaseWarningRule[P]>
    : Prisma.GetScalarType<T[P], AggregateDiseaseWarningRule[P]>
}
...
type GetDiseaseWarningRuleGroupByPayload<T extends DiseaseWarningRuleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DiseaseWarningRuleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DiseaseWarningRuleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DiseaseWarningRuleGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DiseaseWarningRuleGroupByOutputType[P]>
      }
    >
  >
...
export type DiseaseWarningRuleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DiseaseWarningRuleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DiseaseWarningRuleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DiseaseWarningRule'], meta: { name: 'DiseaseWarningRule' } }
  /**
   ...
   * })
  **/
  count<T extends DiseaseWarningRuleCountArgs>(
    args?: Prisma.Subset<T, DiseaseWarningRuleCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DiseaseWarningRuleCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DiseaseWarningRuleGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DiseaseWarningRuleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDiseaseWarningRuleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

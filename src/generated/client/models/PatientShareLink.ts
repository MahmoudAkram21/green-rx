...
// @ts-nocheck 
/*
 * This file exports the `PatientShareLink` model and its related types.
 *
...
export type GetPatientShareLinkAggregateType<T extends PatientShareLinkAggregateArgs> = {
      [P in keyof T & keyof AggregatePatientShareLink]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePatientShareLink[P]>
    : Prisma.GetScalarType<T[P], AggregatePatientShareLink[P]>
}
...
type GetPatientShareLinkGroupByPayload<T extends PatientShareLinkGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PatientShareLinkGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PatientShareLinkGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PatientShareLinkGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PatientShareLinkGroupByOutputType[P]>
      }
    >
  >
...
export type PatientShareLinkCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PatientShareLinkFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PatientShareLinkDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PatientShareLink'], meta: { name: 'PatientShareLink' } }
  /**
   ...
   * })
  **/
  count<T extends PatientShareLinkCountArgs>(
    args?: Prisma.Subset<T, PatientShareLinkCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PatientShareLinkCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PatientShareLinkGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PatientShareLinkGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPatientShareLinkGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

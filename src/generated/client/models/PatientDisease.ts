...
// @ts-nocheck 
/*
 * This file exports the `PatientDisease` model and its related types.
 *
...
export type GetPatientDiseaseAggregateType<T extends PatientDiseaseAggregateArgs> = {
      [P in keyof T & keyof AggregatePatientDisease]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePatientDisease[P]>
    : Prisma.GetScalarType<T[P], AggregatePatientDisease[P]>
}
...
type GetPatientDiseaseGroupByPayload<T extends PatientDiseaseGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PatientDiseaseGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PatientDiseaseGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PatientDiseaseGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PatientDiseaseGroupByOutputType[P]>
      }
    >
  >
...
export type PatientDiseaseCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PatientDiseaseFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PatientDiseaseDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PatientDisease'], meta: { name: 'PatientDisease' } }
  /**
   ...
   * })
  **/
  count<T extends PatientDiseaseCountArgs>(
    args?: Prisma.Subset<T, PatientDiseaseCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PatientDiseaseCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PatientDiseaseGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PatientDiseaseGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPatientDiseaseGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
